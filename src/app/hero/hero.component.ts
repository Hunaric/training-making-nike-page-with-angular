...
@Component({
  ...
  template: `
    ...
    >
      <div
        class="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:sm:px-16 max-xl:px-8 pt-28"
      >
        <p class="text-xl font-montserrat text-red-400">
        ...
        >
          <span
            class="xl:bg-white xl:bg-opacity-50 xl:whitespace-nowrap relative z-10 pr-10 rounded-full"
        ...
        <p
          class="font-montserrat text-gray-400 text-lg leading-8 mt-6 mb-14 sm:max-w-sm "
        >
        ...
        <div
          class="flex justify-start items-start flex-wrap w-fit mt-20 gap-16"
        >
          <div *ngFor="let stat of statistics">
            <p class="text-4xl font-palanquin font-bold">{{ stat.value }}</p>
            <p class="font-montserrat leading-7 text-gray-500">
              {{ stat.label }}
            </p>
          </div>
        </div>
      ...
      <div
        class="relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-gray-100 bg-cover bg-center"
        [ngStyle]="{ 'background-image': 'url(' + bgBigCard + ')' }"
      >
        <img
          src="{{ bigShoeImage }}"
          alt="Big Shoe 1"
            ...
            <div
              ...
              [ngClass]="
                bigShoeImage === shoe.bigShoe
                  ...
                  : 'border-transparent'
              "
              (click)="changeBigShoe(shoe)"
            >
              <div
                class="flex justify-center items-center bg-center bg-cover sm:w-40 sm:h-40 rounded-xl max-sm:p-4"
